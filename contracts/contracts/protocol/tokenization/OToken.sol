...
import {IOrmiIncentivesController} from '../../interfaces/IOrmiIncentivesController.sol';

/**
 * @title Ormi ERC20 oToken
 * @dev Implementation of the interest bearing token for the Ormi protocol
 * @author Ormi
 */
contract oToken is
  ...
  IOToken
{
  ...
  IOrmiIncentivesController internal _incentivesController;
   ...
   * @param treasury The address of the Ormi treasury, receiving the fees on this oToken
  ...
  /**
   * @dev Returns the address of the Ormi treasury, receiving the fees on this oToken
   **/
   ...
   **/
  function _getIncentivesController() internal view override returns (IOrmiIncentivesController) {
   ...
   **/
  function getIncentivesController() external view override returns (IOrmiIncentivesController) {
