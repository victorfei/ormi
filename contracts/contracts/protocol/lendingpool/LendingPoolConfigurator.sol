...
} from '../libraries/Ormi-upgradeability/InitializableImmutableAdminUpgradeabilityProxy.sol';
 ...
 * @author Ormi
 * @dev Implements the configuration methods for the Ormi protocol
 **/
    ...
    address oTokenProxyAddress =
      _initTokenWithProxy(
        ...
        abi.encodeWithSelector(
          ...
          IOrmiIncentivesController(input.incentivesController),
