...
interface ILendingPool {
   ...
   * @param receiveAToken `true` if the liquidators wants to receive the collateral oTokens, `false` if he wants
   ...
   * For further details please visit https://developers.ormi.fi
